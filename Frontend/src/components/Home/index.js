        ...
        <>
            <div className="container-home-page">
                <div className="text-zone" style={{textAlign: 'center'}}>
                    <b><h1 style={{ display: 'block', borderRadius: '0px', marginBottom: '20px', padding: '10px', fontSize: '48px', background: 'linear-gradient(360deg, #470476ff, #040039c8)'}}>Premier League Fantasy</h1></b>
